...
const CAT_ACCESSORIES = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1599488615731-7e5c2823ff28?w=250&h=250&fit=crop",
    position: "neck",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1511499767150-a48a237f0083?w=250&h=250&fit=crop",
    position: "eyes",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1520903920243-00d872a2d1c9?w=250&h=250&fit=crop",
    position: "neck",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1601121141461-9d6647bca1ed?w=250&h=250&fit=crop",
    position: "neck",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1597848212624-a19eb35e2651?w=250&h=250&fit=crop",
    position: "head",
...
const LEVEL_PERKS = [
  {
    level: 1,
    perk: "Basic Loan Access",
    interestRate: "12%",
    maxAmount: "$10000",
  },
  {
    level: 2,
    perk: "Reduced Interest Rate",
    interestRate: "10%",
    maxAmount: "$25000",
  },
  {
    level: 3,
    perk: "Increased Loan Amount",
    interestRate: "8%",
    maxAmount: "$27000",
  },
  {
    level: 4,
    perk: "Priority Processing",
    interestRate: "7%",
    maxAmount: "$29000",
  },
  {
    level: 5,
    perk: "Premium Loan Terms",
    interestRate: "5%",
    maxAmount: "$30000",
  },
];
...
export default function PetPage() {
  ...
  useEffect(() => {
    ...
    const initialReputation = storedReputation
      ? Number.parseInt(storedReputation, 10)
      : 150; // Default to 150 (Level 2 with 50% progress)

    const storedEquippedItems = localStorage.getItem("equippedItems");
    const initialEquippedItems = storedEquippedItems
      ? JSON.parse(storedEquippedItems)
      : [1]; // Default to having the first item equipped

    const storedAccessories = localStorage.getItem("equippedAccessories");
    const initialAccessories = storedAccessories
      ? JSON.parse(storedAccessories)
      : []; // Default to no accessories
  ...
  const toggleAccessory = (accessoryId: number) => {
    ...
    if (equippedAccessories.includes(accessoryId)) {
      // Unequip accessory
      newEquippedAccessories = equippedAccessories.filter(
        (id) => id !== accessoryId
      );
    } else {
      ...
      const filteredAccessories = equippedAccessories.filter((id) => {
        ...
        return (
          equippedAccessory && equippedAccessory.position !== accessory.position
        );
      });
    ...
    localStorage.setItem(
      "equippedAccessories",
      JSON.stringify(newEquippedAccessories)
    );
  };
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="relative">
                ...
                <div className="absolute top-0 left-0 w-full h-full">
                  {equippedAccessories.map((accessoryId) => {
                    const accessory = CAT_ACCESSORIES.find(
                      (a) => a.id === accessoryId
                    );
                    ...
                    return (
                      <div
                        key={accessoryId}
                        className={`absolute ${accessory.style}`}
                      >
                        <Image
          ...
          <Card className="md:col-span-2">
            <CardHeader>
              ...
              <CardDescription>
                Your cat's reputation directly impacts microloan eligibility and
                terms
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Tabs defaultValue="accessories">
                ...
                <TabsContent value="accessories">
                  <div className="mb-4 p-3 bg-muted rounded-lg">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Customize your cat with accessories you've earned or
                      purchased. You can equip one accessory per position (head,
                      eyes, neck).
                    </p>
                  </div>
                ...
                <TabsContent value="loan-terms" className="space-y-4">
                  <div className="bg-primary/5 p-4 rounded-lg border border-primary/20">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      ...
                      <div className="flex flex-col items-center p-3 bg-white rounded-lg shadow-sm">
                        ...
                        <span className="text-xl font-bold">
                          {getCurrentLoanTerms().interestRate}
                        </span>
                      </div>
                      <div className="flex flex-col items-center p-3 bg-white rounded-lg shadow-sm">
                  ...
                  {getNextPerk() && (
                    <div className="mt-4">
                      <p className="text-sm">
                        <span className="font-medium">Next upgrade:</span> Need{" "}
                        {100 - progress} more reputation points to unlock Level{" "}
                        {level + 1} benefits
                      </p>
                    </div>
                  )}
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="p-4 border rounded-lg">
                        ...
                        <p className="text-sm text-muted-foreground mt-1">
                          From equipped financial credentials
                        </p>
                      </div>
                      <div className="p-4 border rounded-lg col-span-2">
                        ...
                        <div className="mt-2 text-sm">
                          ...
                          <ul className="list-disc pl-5 text-muted-foreground space-y-1 mt-1">
                            ...
                            <li>
                              Unlocks special financial perks and opportunities
                            </li>
                          </ul>
                        </div>
                      </div>
