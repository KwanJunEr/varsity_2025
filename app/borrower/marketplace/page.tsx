      ...
      <Tabs defaultValue="swags" className="mt-8" onValueChange={setActiveTab}>
        ...
        <TabsContent value="swags" className="mt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {swagItems.map((item) => (
              <ProductCard key={item.id} product={item} onPurchase={openPurchaseModal} />
            ))}
          </div>
        </TabsContent>
    ...
    <div className="bg-primary/10 rounded-lg p-4 flex items-center justify-between">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Use tokens to redeem marketplace items</p>
        </div>
      </div>
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            You are about to redeem the following item with your contribution tokens.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="grid gap-4 py-4">
          ...
          <div className="bg-muted p-3 rounded-md">
            ...
            <div className="border-t border-border mt-2 pt-2 flex justify-between items-center font-medium">
              <span>Remaining:</span>
              <span className={!canPurchase ? "text-destructive" : ""}>{userTokens - product.price}</span>
            </div>
          </div>
        ...
        <DialogFooter>
          ...
          <Button onClick={onPurchase} disabled={!canPurchase} className="gap-2">
...
const swagItems: Product[] = [
  ...
  },
  {
    ...
    price: 100,
    image: "https://images.unsplash.com/photo-1589384267710-7a170981ca78?w=500&auto=format&fit=crop&q=60",
  },
]
...
const petDecorationItems: Product[] = [
  ...
  },
  {
    ...
    price: 120,
    image: "https://images.unsplash.com/photo-1605897472359-85e4b94c6a04?w=500&auto=format&fit=crop&q=60",
  },
  {
    id: 9,
    name: "Pet Costume",
    ...
    price: 350,
    image: "https://images.unsplash.com/photo-1535979863199-3c77338429a0?w=500&auto=format&fit=crop&q=60",
  },
  {
    id: 10,
  ...
  },
  {
    ...
    price: 200,
    image: "https://images.unsplash.com/photo-1576473086800-c0f9e1eb5a10?w=500&auto=format&fit=crop&q=60",
  },
  {
    id: 12,
    name: "Pet Sweater",
    ...
    price: 300,
    image: "https://images.unsplash.com/photo-1541364983171-a8ba01e95cfc?w=500&auto=format&fit=crop&q=60",
  },
]
