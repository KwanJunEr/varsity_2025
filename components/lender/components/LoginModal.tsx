    ...
    <DialogContent className="sm:max-w-[425px]">
      {step === "initial" && (
        <>
          <DialogHeader>
            ...
            <DialogDescription>
              Sign in to your account or continue with Google to connect your wallet.
            </DialogDescription>
          </DialogHeader>
      ...
      {step === "loading" && (
        <div className="flex flex-col items-center justify-center py-10">
          ...
          <p className="mt-4 text-center text-muted-foreground">Processing your request...</p>
        </div>
      )}
      ...
      {step === "metamask" && (
        <>
          <DialogHeader>
            ...
            <DialogDescription>Connecting with your MetaMask wallet to access the LendDAO platform.</DialogDescription>
          </DialogHeader>
          <div className="flex flex-col items-center justify-center py-6">
            <div className="mb-6 rounded-full bg-orange-100 p-3 dark:bg-orange-900/20">
              <svg className="h-12 w-12" viewBox="0 0 35 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <p className="mt-4 text-center text-sm text-muted-foreground">
              Your Metamask Account Will Be Connected Once You Approve the Connection
            </p>
          </div>
        </>
      )}
      ...
      {step === "success" && (
        <div className="flex flex-col items-center justify-center py-10">
          ...
          <h3 className="mt-4 text-lg font-medium">Successfully Connected!</h3>
          <p className="mt-2 text-center text-muted-foreground">Redirecting you to the dashboard...</p>
        </div>
      )}
    </DialogContent>
  </Dialog>
